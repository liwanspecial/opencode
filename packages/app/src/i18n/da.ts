export const dict = {
  ...
  "command.session.rename": "Omdøb session",
  "command.session.rename.description": "Skift titlen på den aktuelle session",
  ...
  "dialog.session.rename.title": "Omdøb session",
  "dialog.session.rename.name": "Sessionsnavn",
  "dialog.session.rename.error.empty": "Indtast et sessionsnavn.",
  "dialog.session.rename.failed.title": "Kunne ikke omdøbe session",
  ...
  "sidebar.project.sessions.collapse": "Skjul sessioner",
  "sidebar.project.sessions.expand": "Udvid sessioner",
  ...
  "settings.general.background.image.title": "Baggrundsbillede",
  "settings.general.background.image.description": "Vælg et lokalt billede, der skal vises over appens baggrund",
  "settings.general.background.choose": "Vælg billede",
  "settings.general.background.choose.title": "Vælg baggrundsbillede",
  "settings.general.background.clear": "Ryd",
  "settings.general.background.enabled.title": "Vis baggrundsbillede",
  "settings.general.background.enabled.description": "Vis det valgte billede som en diskret appbaggrund",
  "settings.general.background.fit.title": "Baggrundslayout",
  "settings.general.background.fit.description": "Vælg hvordan baggrundsbilledet vises",
  "settings.general.background.fit.cover": "Dæk",
  "settings.general.background.fit.contain": "Tilpas",
  "settings.general.background.fit.repeat": "Gentag",
  "settings.general.background.opacity.title": "Baggrundens opacitet",
  "settings.general.background.blur.title": "Baggrundssløring",
  ...
  "dialog.archivedSessions.menu": "Arkiverede sessioner",
  ...
  "dialog.archivedSessions.delete": "Slet permanent",
  "dialog.archivedSessions.delete.confirm": 'Slet session "{{name}}" permanent?',
  "dialog.archivedSessions.loadFailed.title": "Kunne ikke indlæse arkiverede sessioner",
  "dialog.archivedSessions.restoreFailed.title": "Kunne ikke gendanne session",
  "settings.general.row.archivedSessions.title": "Arkiverede sessioner",
  "settings.general.row.archivedSessions.description":
    "Gennemgå arkiverede sessioner, og gendan eller slet dem permanent.",
  "settings.general.row.archivedSessions.action": "Administrer",
