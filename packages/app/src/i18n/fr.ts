export const dict = {
  ...
  "command.session.rename": "Renommer la session",
  "command.session.rename.description": "Modifier le titre de la session actuelle",
  ...
  "dialog.session.rename.title": "Renommer la session",
  "dialog.session.rename.name": "Nom de la session",
  "dialog.session.rename.error.empty": "Saisissez un nom de session.",
  "dialog.session.rename.failed.title": "Échec du renommage de la session",
  ...
  "sidebar.project.sessions.collapse": "Réduire les sessions",
  "sidebar.project.sessions.expand": "Développer les sessions",
  ...
  "settings.general.background.image.title": "Image d'arrière-plan",
  "settings.general.background.image.description":
    "Choisissez une image locale à afficher sur l'arrière-plan de l'application",
  "settings.general.background.choose": "Choisir une image",
  "settings.general.background.choose.title": "Choisir l'image d'arrière-plan",
  "settings.general.background.clear": "Effacer",
  "settings.general.background.enabled.title": "Afficher l'image d'arrière-plan",
  "settings.general.background.enabled.description":
    "Afficher l'image sélectionnée comme arrière-plan discret de l'application",
  "settings.general.background.fit.title": "Disposition de l'arrière-plan",
  "settings.general.background.fit.description": "Choisir le mode d'affichage de l'image d'arrière-plan",
  "settings.general.background.fit.cover": "Couvrir",
  "settings.general.background.fit.contain": "Contenir",
  "settings.general.background.fit.repeat": "Répéter",
  "settings.general.background.opacity.title": "Opacité de l'arrière-plan",
  "settings.general.background.blur.title": "Flou de l'arrière-plan",
  ...
  "dialog.archivedSessions.menu": "Sessions archivées",
  "dialog.archivedSessions.title": "Sessions archivées",
  "dialog.archivedSessions.empty": "Aucune session archivée",
  "dialog.archivedSessions.search.placeholder": "Rechercher des sessions archivées",
  "dialog.archivedSessions.restore": "Restaurer",
  "dialog.archivedSessions.delete": "Supprimer définitivement",
  "dialog.archivedSessions.delete.confirm": 'Supprimer définitivement la session "{{name}}" ?',
  "dialog.archivedSessions.loadFailed.title": "Échec du chargement des sessions archivées",
  "dialog.archivedSessions.restoreFailed.title": "Échec de la restauration de la session",
  "settings.general.row.archivedSessions.title": "Sessions archivées",
  "settings.general.row.archivedSessions.description":
    "Consultez les sessions archivées et restaurez-les ou supprimez-les définitivement.",
  "settings.general.row.archivedSessions.action": "Gérer",
