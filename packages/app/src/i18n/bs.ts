export const dict = {
  ...
  "dialog.session.rename.error.empty": "Unesi naziv sesije.",
  ...
  "settings.general.background.image.description": "Odaberi lokalnu sliku za prikaz preko pozadine aplikacije",
  ...
  "settings.general.background.fit.description": "Odaberi kako se pozadinska slika prikazuje",
  "settings.general.background.fit.cover": "Popuni",
  ...
  "dialog.archivedSessions.loadFailed.title": "Nije uspjelo učitavanje arhiviranih sesija",
  ...
  "settings.general.row.archivedSessions.description": "Pregledaj arhivirane sesije i vrati ih ili trajno izbriši.",
