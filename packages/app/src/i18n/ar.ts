export const dict = {
  ...
  "command.session.rename": "إعادة تسمية الجلسة",
  "command.session.rename.description": "تغيير عنوان الجلسة الحالية",
  ...
  "dialog.session.rename.title": "إعادة تسمية الجلسة",
  "dialog.session.rename.name": "اسم الجلسة",
  "dialog.session.rename.error.empty": "أدخل اسم جلسة.",
  "dialog.session.rename.failed.title": "فشلت إعادة تسمية الجلسة",
  ...
  "sidebar.project.sessions.collapse": "طي الجلسات",
  "sidebar.project.sessions.expand": "توسيع الجلسات",
  ...
  "settings.general.background.image.title": "صورة الخلفية",
  "settings.general.background.image.description": "اختر صورة محلية لعرضها فوق خلفية التطبيق",
  "settings.general.background.choose": "اختيار صورة",
  "settings.general.background.choose.title": "اختيار صورة خلفية",
  "settings.general.background.clear": "مسح",
  "settings.general.background.enabled.title": "إظهار صورة الخلفية",
  "settings.general.background.enabled.description": "عرض الصورة المحددة كخلفية خفيفة للتطبيق",
  "settings.general.background.fit.title": "تخطيط الخلفية",
  "settings.general.background.fit.description": "اختر كيفية رسم صورة الخلفية",
  "settings.general.background.fit.cover": "تغطية",
  "settings.general.background.fit.contain": "احتواء",
  "settings.general.background.fit.repeat": "تكرار",
  "settings.general.background.opacity.title": "عتامة الخلفية",
  "settings.general.background.blur.title": "تمويه الخلفية",
  ...
  "dialog.archivedSessions.menu": "الجلسات المؤرشفة",
  "dialog.archivedSessions.title": "الجلسات المؤرشفة",
  "dialog.archivedSessions.empty": "لا توجد جلسات مؤرشفة",
  "dialog.archivedSessions.search.placeholder": "البحث في الجلسات المؤرشفة",
  "dialog.archivedSessions.restore": "استعادة",
  "dialog.archivedSessions.delete": "حذف نهائيًا",
  "dialog.archivedSessions.delete.confirm": 'حذف الجلسة "{{name}}" نهائيًا؟',
  "dialog.archivedSessions.loadFailed.title": "فشل تحميل الجلسات المؤرشفة",
  "dialog.archivedSessions.restoreFailed.title": "فشلت استعادة الجلسة",
  "settings.general.row.archivedSessions.title": "الجلسات المؤرشفة",
  "settings.general.row.archivedSessions.description": "راجع الجلسات المؤرشفة واستعدها أو احذفها نهائيًا.",
  "settings.general.row.archivedSessions.action": "إدارة",
