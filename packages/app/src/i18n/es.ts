export const dict = {
  ...
  "command.session.rename": "Renombrar sesión",
  "command.session.rename.description": "Cambiar el título de la sesión actual",
  ...
  "dialog.session.rename.title": "Renombrar sesión",
  "dialog.session.rename.name": "Nombre de la sesión",
  "dialog.session.rename.error.empty": "Introduce un nombre de sesión.",
  "dialog.session.rename.failed.title": "Fallo al renombrar sesión",
  ...
  "sidebar.project.sessions.collapse": "Contraer sesiones",
  "sidebar.project.sessions.expand": "Expandir sesiones",
  ...
  "settings.general.background.image.title": "Imagen de fondo",
  "settings.general.background.image.description":
    "Elige una imagen local para mostrarla sobre el fondo de la aplicación",
  "settings.general.background.choose": "Elegir imagen",
  "settings.general.background.choose.title": "Elegir imagen de fondo",
  "settings.general.background.clear": "Limpiar",
  "settings.general.background.enabled.title": "Mostrar imagen de fondo",
  "settings.general.background.enabled.description":
    "Mostrar la imagen seleccionada como un fondo sutil de la aplicación",
  "settings.general.background.fit.title": "Disposición del fondo",
  "settings.general.background.fit.description": "Elige cómo se dibuja la imagen de fondo",
  "settings.general.background.fit.cover": "Cubrir",
  "settings.general.background.fit.contain": "Contener",
  "settings.general.background.fit.repeat": "Repetir",
  "settings.general.background.opacity.title": "Opacidad del fondo",
  "settings.general.background.blur.title": "Desenfoque del fondo",
  ...
  "dialog.archivedSessions.menu": "Sesiones archivadas",
  ...
  "dialog.archivedSessions.delete": "Eliminar permanentemente",
  "dialog.archivedSessions.delete.confirm": '¿Eliminar permanentemente la sesión "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Fallo al cargar sesiones archivadas",
  "dialog.archivedSessions.restoreFailed.title": "Fallo al restaurar sesión",
  "settings.general.row.archivedSessions.title": "Sesiones archivadas",
  "settings.general.row.archivedSessions.description":
    "Revisa las sesiones archivadas y restáuralas o elimínalas permanentemente.",
  "settings.general.row.archivedSessions.action": "Gestionar",
