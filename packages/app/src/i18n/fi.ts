export const dict = {
  ...
  "command.session.rename": "Nimeä istunto uudelleen",
  "command.session.rename.description": "Muuta nykyisen istunnon otsikkoa",
  ...
  "dialog.session.rename.title": "Nimeä istunto uudelleen",
  "dialog.session.rename.name": "Istunnon nimi",
  "dialog.session.rename.error.empty": "Anna istunnon nimi.",
  "dialog.session.rename.failed.title": "Istunnon nimen muuttaminen epäonnistui",
  ...
  "sidebar.project.sessions.collapse": "Kutista istunnot",
  "sidebar.project.sessions.expand": "Laajenna istunnot",
  ...
  "settings.general.background.image.title": "Taustakuva",
  "settings.general.background.image.description": "Valitse paikallinen kuva näytettäväksi sovelluksen taustalla",
  "settings.general.background.choose": "Valitse kuva",
  "settings.general.background.choose.title": "Valitse taustakuva",
  "settings.general.background.clear": "Tyhjennä",
  "settings.general.background.enabled.title": "Näytä taustakuva",
  "settings.general.background.enabled.description": "Näytä valittu kuva hillittynä sovelluksen taustana",
  "settings.general.background.fit.title": "Taustan asettelu",
  "settings.general.background.fit.description": "Valitse, miten taustakuva piirretään",
  "settings.general.background.fit.cover": "Peitä",
  "settings.general.background.fit.contain": "Sovita",
  "settings.general.background.fit.repeat": "Toista",
  "settings.general.background.opacity.title": "Taustan peittävyys",
  "settings.general.background.blur.title": "Taustan sumennus",
  ...
  "dialog.archivedSessions.menu": "Arkistoidut istunnot",
  "dialog.archivedSessions.title": "Arkistoidut istunnot",
  "dialog.archivedSessions.empty": "Ei arkistoituja istuntoja",
  "dialog.archivedSessions.search.placeholder": "Hae arkistoituja istuntoja",
  "dialog.archivedSessions.restore": "Palauta",
  "dialog.archivedSessions.delete": "Poista pysyvästi",
  "dialog.archivedSessions.delete.confirm": 'Poistetaanko istunto "{{name}}" pysyvästi?',
  "dialog.archivedSessions.loadFailed.title": "Arkistoitujen istuntojen lataaminen epäonnistui",
  "dialog.archivedSessions.restoreFailed.title": "Istunnon palauttaminen epäonnistui",
  "settings.general.row.archivedSessions.title": "Arkistoidut istunnot",
  "settings.general.row.archivedSessions.description":
    "Tarkastele arkistoituja istuntoja ja palauta tai poista niitä pysyvästi.",
  "settings.general.row.archivedSessions.action": "Hallitse",
