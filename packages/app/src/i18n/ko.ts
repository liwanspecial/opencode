export const dict = {
  ...
  "command.session.rename": "세션 이름 바꾸기",
  "command.session.rename.description": "현재 세션 제목 변경",
  ...
  "dialog.session.rename.title": "세션 이름 바꾸기",
  "dialog.session.rename.name": "세션 이름",
  "dialog.session.rename.error.empty": "세션 이름을 입력하세요.",
  "dialog.session.rename.failed.title": "세션 이름 바꾸기 실패",
  ...
  "settings.general.background.image.title": "배경 이미지",
  "settings.general.background.image.description": "앱 배경에 표시할 로컬 이미지를 선택하세요",
  "settings.general.background.choose": "이미지 선택",
  "settings.general.background.choose.title": "배경 이미지 선택",
  "settings.general.background.clear": "지우기",
  "settings.general.background.enabled.title": "배경 이미지 표시",
  "settings.general.background.enabled.description": "선택한 이미지를 은은한 앱 배경으로 표시합니다",
  "settings.general.background.fit.title": "배경 레이아웃",
  "settings.general.background.fit.description": "배경 이미지가 표시되는 방식을 선택하세요",
  "settings.general.background.fit.cover": "채우기",
  "settings.general.background.fit.contain": "맞춤",
  "settings.general.background.fit.repeat": "반복",
  "settings.general.background.opacity.title": "배경 불투명도",
  "settings.general.background.blur.title": "배경 흐림",
  ...
  "dialog.archivedSessions.menu": "보관된 세션",
  "dialog.archivedSessions.title": "보관된 세션",
  "dialog.archivedSessions.empty": "보관된 세션 없음",
  "dialog.archivedSessions.search.placeholder": "보관된 세션 검색",
  "dialog.archivedSessions.restore": "복원",
  "dialog.archivedSessions.delete": "영구 삭제",
  "dialog.archivedSessions.delete.confirm": '"{{name}}" 세션을 영구 삭제하시겠습니까?',
  "dialog.archivedSessions.loadFailed.title": "보관된 세션 로드 실패",
  "dialog.archivedSessions.restoreFailed.title": "세션 복원 실패",
  "settings.general.row.archivedSessions.title": "보관된 세션",
  "settings.general.row.archivedSessions.description": "보관된 세션을 검토하고 복원하거나 영구 삭제합니다.",
  "settings.general.row.archivedSessions.action": "관리",
