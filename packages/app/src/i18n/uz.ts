export const dict = {
  ...
  "command.session.rename": "Sessiya nomini o'zgartirish",
  "command.session.rename.description": "Joriy sessiya sarlavhasini o'zgartirish",
  ...
  "dialog.session.rename.title": "Sessiya nomini o'zgartirish",
  "dialog.session.rename.name": "Sessiya nomi",
  "dialog.session.rename.error.empty": "Sessiya nomini kiriting.",
  "dialog.session.rename.failed.title": "Sessiya nomini o'zgartirib bo'lmadi",
  ...
  "sidebar.project.sessions.collapse": "Sessiyalarni yig'ish",
  "sidebar.project.sessions.expand": "Sessiyalarni kengaytirish",
  ...
  "settings.general.background.image.title": "Fon rasmi",
  "settings.general.background.image.description": "Ilova fonida ko'rsatish uchun mahalliy rasmni tanlang",
  "settings.general.background.choose": "Rasm tanlash",
  "settings.general.background.choose.title": "Fon rasmini tanlash",
  "settings.general.background.clear": "Tozalash",
  "settings.general.background.enabled.title": "Fon rasmini ko'rsatish",
  "settings.general.background.enabled.description": "Tanlangan rasmni ilovaning nozik foni sifatida ko'rsatish",
  "settings.general.background.fit.title": "Fon joylashuvi",
  "settings.general.background.fit.description": "Fon rasmi qanday chizilishini tanlang",
  "settings.general.background.fit.cover": "Qoplash",
  "settings.general.background.fit.contain": "Sig'dirish",
  "settings.general.background.fit.repeat": "Takrorlash",
  "settings.general.background.opacity.title": "Fon shaffofligi",
  "settings.general.background.blur.title": "Fon xiraligi",
  ...
  "dialog.archivedSessions.menu": "Arxivlangan sessiyalar",
  "dialog.archivedSessions.title": "Arxivlangan sessiyalar",
  "dialog.archivedSessions.empty": "Arxivlangan sessiyalar yo'q",
  "dialog.archivedSessions.search.placeholder": "Arxivlangan sessiyalarni qidirish",
  "dialog.archivedSessions.restore": "Tiklash",
  "dialog.archivedSessions.delete": "Butunlay o'chirish",
  "dialog.archivedSessions.delete.confirm": '"{{name}}" sessiyasi butunlay o\'chirilsinmi?',
  "dialog.archivedSessions.loadFailed.title": "Arxivlangan sessiyalarni yuklab bo'lmadi",
  "dialog.archivedSessions.restoreFailed.title": "Sessiyani tiklab bo'lmadi",
  "settings.general.row.archivedSessions.title": "Arxivlangan sessiyalar",
  "settings.general.row.archivedSessions.description":
    "Arxivlangan sessiyalarni ko'ring va ularni tiklang yoki butunlay o'chiring.",
  "settings.general.row.archivedSessions.action": "Boshqarish",
