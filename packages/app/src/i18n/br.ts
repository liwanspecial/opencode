export const dict = {
  ...
  "command.session.rename": "Renomear sessão",
  "command.session.rename.description": "Alterar o título da sessão atual",
  ...
  "dialog.session.rename.title": "Renomear sessão",
  "dialog.session.rename.name": "Nome da sessão",
  "dialog.session.rename.error.empty": "Digite um nome para a sessão.",
  "dialog.session.rename.failed.title": "Falha ao renomear sessão",
  ...
  "settings.general.background.image.title": "Imagem de fundo",
  "settings.general.background.image.description": "Escolha uma imagem local para exibir sobre o fundo do aplicativo",
  "settings.general.background.choose": "Escolher imagem",
  "settings.general.background.choose.title": "Escolher imagem de fundo",
  "settings.general.background.clear": "Limpar",
  "settings.general.background.enabled.title": "Mostrar imagem de fundo",
  "settings.general.background.enabled.description": "Exibir a imagem selecionada como um fundo sutil do aplicativo",
  "settings.general.background.fit.title": "Layout do fundo",
  "settings.general.background.fit.description": "Escolha como a imagem de fundo é desenhada",
  "settings.general.background.fit.cover": "Cobrir",
  "settings.general.background.fit.contain": "Conter",
  "settings.general.background.fit.repeat": "Repetir",
  "settings.general.background.opacity.title": "Opacidade do fundo",
  "settings.general.background.blur.title": "Desfoque do fundo",
  ...
  "dialog.archivedSessions.menu": "Sessões arquivadas",
  "dialog.archivedSessions.title": "Sessões arquivadas",
  "dialog.archivedSessions.empty": "Nenhuma sessão arquivada",
  "dialog.archivedSessions.search.placeholder": "Buscar sessões arquivadas",
  "dialog.archivedSessions.restore": "Restaurar",
  "dialog.archivedSessions.delete": "Excluir permanentemente",
  "dialog.archivedSessions.delete.confirm": 'Excluir a sessão "{{name}}" permanentemente?',
  "dialog.archivedSessions.loadFailed.title": "Falha ao carregar sessões arquivadas",
  "dialog.archivedSessions.restoreFailed.title": "Falha ao restaurar sessão",
  "settings.general.row.archivedSessions.title": "Sessões arquivadas",
  "settings.general.row.archivedSessions.description":
    "Revise as sessões arquivadas e restaure-as ou exclua-as permanentemente.",
  "settings.general.row.archivedSessions.action": "Gerenciar",
