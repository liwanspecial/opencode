export const dict = {
  ...
  "command.session.rename": "Đổi tên phiên",
  "command.session.rename.description": "Thay đổi tiêu đề phiên hiện tại",
  ...
  "dialog.session.rename.title": "Đổi tên phiên",
  "dialog.session.rename.name": "Tên phiên",
  "dialog.session.rename.error.empty": "Nhập tên phiên.",
  "dialog.session.rename.failed.title": "Không thể đổi tên phiên",
  ...
  "sidebar.project.sessions.collapse": "Thu gọn phiên",
  "sidebar.project.sessions.expand": "Mở rộng phiên",
  ...
  "settings.general.background.image.title": "Hình nền",
  "settings.general.background.image.description": "Chọn hình ảnh cục bộ để hiển thị trên nền ứng dụng",
  "settings.general.background.choose": "Chọn hình ảnh",
  "settings.general.background.choose.title": "Chọn hình nền",
  "settings.general.background.clear": "Xóa",
  "settings.general.background.enabled.title": "Hiển thị hình nền",
  "settings.general.background.enabled.description": "Hiển thị hình ảnh đã chọn làm nền tinh tế cho ứng dụng",
  "settings.general.background.fit.title": "Bố cục hình nền",
  "settings.general.background.fit.description": "Chọn cách vẽ hình nền",
  "settings.general.background.fit.cover": "Phủ kín",
  "settings.general.background.fit.contain": "Chứa vừa",
  "settings.general.background.fit.repeat": "Lặp lại",
  "settings.general.background.opacity.title": "Độ mờ hình nền",
  "settings.general.background.blur.title": "Độ làm mờ hình nền",
  ...
  "dialog.archivedSessions.menu": "Phiên đã lưu trữ",
  "dialog.archivedSessions.title": "Phiên đã lưu trữ",
  "dialog.archivedSessions.empty": "Không có phiên đã lưu trữ",
  "dialog.archivedSessions.search.placeholder": "Tìm kiếm phiên đã lưu trữ",
  "dialog.archivedSessions.restore": "Khôi phục",
  "dialog.archivedSessions.delete": "Xóa vĩnh viễn",
  "dialog.archivedSessions.delete.confirm": 'Xóa vĩnh viễn phiên "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Không tải được phiên đã lưu trữ",
  "dialog.archivedSessions.restoreFailed.title": "Không khôi phục được phiên",
  "settings.general.row.archivedSessions.title": "Phiên đã lưu trữ",
  "settings.general.row.archivedSessions.description":
    "Xem lại các phiên đã lưu trữ và khôi phục hoặc xóa vĩnh viễn chúng.",
  "settings.general.row.archivedSessions.action": "Quản lý",
