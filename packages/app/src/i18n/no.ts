...
export const dict = {
  ...
  "command.session.rename": "Gi nytt navn til sesjon",
  "command.session.rename.description": "Endre tittelen på gjeldende sesjon",
  ...
  "dialog.session.rename.title": "Gi nytt navn til sesjon",
  "dialog.session.rename.name": "Sesjonsnavn",
  "dialog.session.rename.error.empty": "Skriv inn et sesjonsnavn.",
  "dialog.session.rename.failed.title": "Kunne ikke gi sesjonen nytt navn",
  ...
  "settings.general.background.image.title": "Bakgrunnsbilde",
  "settings.general.background.image.description": "Velg et lokalt bilde som vises over appbakgrunnen",
  "settings.general.background.choose": "Velg bilde",
  "settings.general.background.choose.title": "Velg bakgrunnsbilde",
  "settings.general.background.clear": "Tøm",
  "settings.general.background.enabled.title": "Vis bakgrunnsbilde",
  "settings.general.background.enabled.description": "Vis det valgte bildet som en nedtonet appbakgrunn",
  "settings.general.background.fit.title": "Bakgrunnsoppsett",
  "settings.general.background.fit.description": "Velg hvordan bakgrunnsbildet vises",
  "settings.general.background.fit.cover": "Dekk",
  "settings.general.background.fit.contain": "Tilpass",
  "settings.general.background.fit.repeat": "Gjenta",
  "settings.general.background.opacity.title": "Bakgrunnsopasitet",
  "settings.general.background.blur.title": "Uskarphet for bakgrunn",
  ...
  "dialog.archivedSessions.menu": "Arkiverte sesjoner",
  "dialog.archivedSessions.title": "Arkiverte sesjoner",
  "dialog.archivedSessions.empty": "Ingen arkiverte sesjoner",
  "dialog.archivedSessions.search.placeholder": "Søk i arkiverte sesjoner",
  "dialog.archivedSessions.restore": "Gjenopprett",
  "dialog.archivedSessions.delete": "Slett permanent",
  "dialog.archivedSessions.delete.confirm": 'Slette sesjonen "{{name}}" permanent?',
  "dialog.archivedSessions.loadFailed.title": "Kunne ikke laste arkiverte sesjoner",
  "dialog.archivedSessions.restoreFailed.title": "Kunne ikke gjenopprette sesjon",
  "settings.general.row.archivedSessions.title": "Arkiverte sesjoner",
  "settings.general.row.archivedSessions.description":
    "Gå gjennom arkiverte sesjoner og gjenopprett eller slett dem permanent.",
