...
export const dict = {
  ...
  "command.session.rename": "重新命名工作階段",
  "command.session.rename.description": "修改目前工作階段標題",
  ...
  "dialog.session.rename.title": "重新命名工作階段",
  "dialog.session.rename.name": "工作階段名稱",
  "dialog.session.rename.error.empty": "請輸入工作階段名稱。",
  "dialog.session.rename.failed.title": "重新命名工作階段失敗",
  ...
  "sidebar.project.sessions.collapse": "收合工作階段",
  "sidebar.project.sessions.expand": "展開工作階段",
  ...
  "settings.general.background.image.title": "背景圖片",
  "settings.general.background.image.description": "選擇一張本機圖片作為應用程式背景",
  "settings.general.background.choose": "選擇圖片",
  "settings.general.background.choose.title": "選擇背景圖片",
  "settings.general.background.clear": "清除",
  "settings.general.background.enabled.title": "顯示背景圖片",
  "settings.general.background.enabled.description": "以低透明度顯示所選圖片作為應用程式背景",
  "settings.general.background.fit.title": "背景版面",
  "settings.general.background.fit.description": "選擇背景圖片的顯示方式",
  "settings.general.background.fit.cover": "填滿",
  "settings.general.background.fit.contain": "符合",
  "settings.general.background.fit.repeat": "重複",
  ...
  "dialog.archivedSessions.menu": "封存工作階段",
  "dialog.archivedSessions.title": "封存工作階段",
  "dialog.archivedSessions.empty": "沒有封存工作階段",
  "dialog.archivedSessions.search.placeholder": "搜尋封存工作階段",
  "dialog.archivedSessions.restore": "還原",
  "dialog.archivedSessions.delete": "永久刪除",
  "dialog.archivedSessions.delete.confirm": '永久刪除工作階段 "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "載入封存工作階段失敗",
  "dialog.archivedSessions.restoreFailed.title": "還原工作階段失敗",
  "settings.general.row.archivedSessions.title": "封存工作階段管理",
  "settings.general.row.archivedSessions.description": "查看所有已封存工作階段，並選擇還原或永久刪除。",
