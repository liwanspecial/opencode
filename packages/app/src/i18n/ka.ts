export const dict = {
  ...
  "command.session.rename": "სესიის გადარქმევა",
  "command.session.rename.description": "მიმდინარე სესიის სათაურის შეცვლა",
  ...
  "dialog.session.rename.title": "სესიის გადარქმევა",
  "dialog.session.rename.name": "სესიის სახელი",
  "dialog.session.rename.error.empty": "შეიყვანეთ სესიის სახელი.",
  "dialog.session.rename.failed.title": "სესიის გადარქმევა ვერ მოხერხდა",
  ...
  "sidebar.project.sessions.collapse": "სესიების ჩაკეცვა",
  "sidebar.project.sessions.expand": "სესიების გაფართოება",
  ...
  "settings.general.background.image.title": "ფონის სურათი",
  "settings.general.background.image.description": "აირჩიეთ ლოკალური სურათი აპის ფონზე საჩვენებლად",
  "settings.general.background.choose": "სურათის არჩევა",
  "settings.general.background.choose.title": "ფონის სურათის არჩევა",
  "settings.general.background.clear": "გასუფთავება",
  "settings.general.background.enabled.title": "ფონის სურათის ჩვენება",
  "settings.general.background.enabled.description": "არჩეული სურათის აპის მსუბუქ ფონად ჩვენება",
  "settings.general.background.fit.title": "ფონის განლაგება",
  "settings.general.background.fit.description": "აირჩიეთ, როგორ გამოისახოს ფონის სურათი",
  "settings.general.background.fit.cover": "შევსება",
  "settings.general.background.fit.contain": "მოთავსება",
  "settings.general.background.fit.repeat": "გამეორება",
  "settings.general.background.opacity.title": "ფონის გაუმჭვირვალობა",
  "settings.general.background.blur.title": "ფონის დაბინდვა",
  ...
  "dialog.archivedSessions.menu": "დაარქივებული სესიები",
  "dialog.archivedSessions.title": "დაარქივებული სესიები",
  "dialog.archivedSessions.empty": "დაარქივებული სესიები არ არის",
  "dialog.archivedSessions.search.placeholder": "დაარქივებული სესიების ძიება",
  "dialog.archivedSessions.restore": "აღდგენა",
  "dialog.archivedSessions.delete": "სამუდამოდ წაშლა",
  "dialog.archivedSessions.delete.confirm": "წაიშალოს სესია „{{name}}“ სამუდამოდ?",
  "dialog.archivedSessions.loadFailed.title": "დაარქივებული სესიების ჩატვირთვა ვერ მოხერხდა",
  "dialog.archivedSessions.restoreFailed.title": "სესიის აღდგენა ვერ მოხერხდა",
  "settings.general.row.archivedSessions.title": "დაარქივებული სესიები",
  "settings.general.row.archivedSessions.description":
    "გადახედეთ დაარქივებულ სესიებს და აღადგინეთ ან სამუდამოდ წაშალეთ ისინი.",
  "settings.general.row.archivedSessions.action": "მართვა",
