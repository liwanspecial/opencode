export const dict = {
  ...
  "command.session.rename": "ប្តូរឈ្មោះសម័យ",
  "command.session.rename.description": "ប្តូរចំណងជើងសម័យបច្ចុប្បន្ន",
  ...
  "dialog.session.rename.title": "ប្តូរឈ្មោះសម័យ",
  "dialog.session.rename.name": "ឈ្មោះសម័យ",
  "dialog.session.rename.error.empty": "បញ្ចូលឈ្មោះសម័យ។",
  "dialog.session.rename.failed.title": "បរាជ័យក្នុងការប្តូរឈ្មោះសម័យ",
  ...
  "sidebar.project.sessions.collapse": "បង្រួមសម័យ",
  "sidebar.project.sessions.expand": "ពង្រីកសម័យ",
  ...
  "settings.general.background.image.title": "រូបភាពផ្ទៃខាងក្រោយ",
  "settings.general.background.image.description": "ជ្រើសរូបភាពពីឧបករណ៍នេះ ដើម្បីបង្ហាញលើផ្ទៃខាងក្រោយកម្មវិធី",
  "settings.general.background.choose": "ជ្រើសរូបភាព",
  "settings.general.background.choose.title": "ជ្រើសរូបភាពផ្ទៃខាងក្រោយ",
  "settings.general.background.clear": "សម្អាត",
  "settings.general.background.enabled.title": "បង្ហាញរូបភាពផ្ទៃខាងក្រោយ",
  "settings.general.background.enabled.description": "បង្ហាញរូបភាពដែលបានជ្រើសជាផ្ទៃខាងក្រោយស្រាលរបស់កម្មវិធី",
  "settings.general.background.fit.title": "ប្លង់ផ្ទៃខាងក្រោយ",
  "settings.general.background.fit.description": "ជ្រើសរបៀបគូររូបភាពផ្ទៃខាងក្រោយ",
  "settings.general.background.fit.cover": "គ្របដណ្តប់",
  "settings.general.background.fit.contain": "ឱ្យសម",
  "settings.general.background.fit.repeat": "ធ្វើម្តងទៀត",
  "settings.general.background.opacity.title": "ភាពស្រអាប់ផ្ទៃខាងក្រោយ",
  "settings.general.background.blur.title": "ភាពព្រិលផ្ទៃខាងក្រោយ",
  ...
  "dialog.archivedSessions.menu": "សម័យដែលបានទុកក្នុងបណ្ណសារ",
  "dialog.archivedSessions.title": "សម័យដែលបានទុកក្នុងបណ្ណសារ",
  "dialog.archivedSessions.empty": "គ្មានសម័យដែលបានទុកក្នុងបណ្ណសារទេ",
  "dialog.archivedSessions.search.placeholder": "ស្វែងរកសម័យដែលបានទុកក្នុងបណ្ណសារ",
  "dialog.archivedSessions.restore": "ស្តារឡើងវិញ",
  "dialog.archivedSessions.delete": "លុបជាអចិន្ត្រៃយ៍",
  "dialog.archivedSessions.delete.confirm": 'លុបសម័យ "{{name}}" ជាអចិន្ត្រៃយ៍?',
  "dialog.archivedSessions.loadFailed.title": "បរាជ័យក្នុងការផ្ទុកសម័យដែលបានទុកក្នុងបណ្ណសារ",
  "dialog.archivedSessions.restoreFailed.title": "បរាជ័យក្នុងការស្តារសម័យ",
  "settings.general.row.archivedSessions.title": "សម័យដែលបានទុកក្នុងបណ្ណសារ",
  "settings.general.row.archivedSessions.description":
    "ពិនិត្យមើលសម័យដែលបានទុកក្នុងបណ្ណសារ ហើយស្តារ ឬលុបវាជាអចិន្ត្រៃយ៍។",
  "settings.general.row.archivedSessions.action": "គ្រប់គ្រង",
