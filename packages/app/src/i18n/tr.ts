...
export const dict = {
  ...
  "command.session.rename": "Oturumu yeniden adlandır",
  "command.session.rename.description": "Mevcut oturum başlığını değiştir",
  ...
  "dialog.session.rename.title": "Oturumu yeniden adlandır",
  "dialog.session.rename.name": "Oturum adı",
  "dialog.session.rename.error.empty": "Bir oturum adı girin.",
  "dialog.session.rename.failed.title": "Oturum yeniden adlandırılamadı",
  ...
  "sidebar.project.sessions.collapse": "Oturumları daralt",
  "sidebar.project.sessions.expand": "Oturumları genişlet",
  ...
  "settings.general.background.image.title": "Arka plan görseli",
  "settings.general.background.image.description": "Uygulama arka planında göstermek için yerel bir görsel seçin",
  "settings.general.background.choose": "Görsel seç",
  "settings.general.background.choose.title": "Arka plan görseli seç",
  "settings.general.background.clear": "Temizle",
  "settings.general.background.enabled.title": "Arka plan görselini göster",
  "settings.general.background.enabled.description": "Seçili görseli hafif bir uygulama arka planı olarak göster",
  "settings.general.background.fit.title": "Arka plan düzeni",
  "settings.general.background.fit.description": "Arka plan görselinin nasıl çizileceğini seçin",
  "settings.general.background.fit.cover": "Kapla",
  "settings.general.background.fit.contain": "Sığdır",
  "settings.general.background.fit.repeat": "Tekrarla",
  "settings.general.background.opacity.title": "Arka plan opaklığı",
  "settings.general.background.blur.title": "Arka plan bulanıklığı",
  ...
  "dialog.archivedSessions.menu": "Arşivlenmiş oturumlar",
  ...
  "dialog.archivedSessions.delete": "Kalıcı olarak sil",
  "dialog.archivedSessions.delete.confirm": '"{{name}}" oturumu kalıcı olarak silinsin mi?',
  "dialog.archivedSessions.loadFailed.title": "Arşivlenmiş oturumlar yüklenemedi",
  "dialog.archivedSessions.restoreFailed.title": "Oturum geri yüklenemedi",
  "settings.general.row.archivedSessions.title": "Arşivlenmiş oturumlar",
  "settings.general.row.archivedSessions.description":
    "Arşivlenmiş oturumları inceleyin; geri yükleyin veya kalıcı olarak silin.",
  "settings.general.row.archivedSessions.action": "Yönet",
