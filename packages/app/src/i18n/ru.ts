export const dict = {
  ...
  "command.session.rename": "Переименовать сессию",
  "command.session.rename.description": "Изменить заголовок текущей сессии",
  ...
  "dialog.session.rename.title": "Переименовать сессию",
  "dialog.session.rename.name": "Название сессии",
  "dialog.session.rename.error.empty": "Введите название сессии.",
  "dialog.session.rename.failed.title": "Не удалось переименовать сессию",
  ...
  "sidebar.project.sessions.collapse": "Свернуть сеансы",
  "sidebar.project.sessions.expand": "Развернуть сеансы",
  ...
  "settings.general.background.image.title": "Фоновое изображение",
  "settings.general.background.image.description": "Выберите локальное изображение для отображения на фоне приложения",
  "settings.general.background.choose": "Выбрать изображение",
  "settings.general.background.choose.title": "Выбрать фоновое изображение",
  "settings.general.background.clear": "Очистить",
  "settings.general.background.enabled.title": "Показывать фоновое изображение",
  "settings.general.background.enabled.description": "Отображать выбранное изображение как ненавязчивый фон приложения",
  "settings.general.background.fit.title": "Размещение фона",
  "settings.general.background.fit.description": "Выберите, как отображать фоновое изображение",
  "settings.general.background.fit.cover": "Заполнить",
  "settings.general.background.fit.contain": "Вместить",
  "settings.general.background.fit.repeat": "Повторять",
  "settings.general.background.opacity.title": "Непрозрачность фона",
  "settings.general.background.blur.title": "Размытие фона",
  ...
  "dialog.archivedSessions.menu": "Архивированные сессии",
  ...
  "dialog.archivedSessions.delete": "Удалить навсегда",
  "dialog.archivedSessions.delete.confirm": 'Удалить сессию "{{name}}" навсегда?',
  "dialog.archivedSessions.loadFailed.title": "Не удалось загрузить архивированные сессии",
  "dialog.archivedSessions.restoreFailed.title": "Не удалось восстановить сессию",
  "settings.general.row.archivedSessions.title": "Архивированные сессии",
  "settings.general.row.archivedSessions.description":
    "Просматривайте архивированные сессии, восстанавливайте их или удаляйте навсегда.",
  "settings.general.row.archivedSessions.action": "Управлять",
