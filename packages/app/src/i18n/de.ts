...
export const dict = {
  ...
  "command.session.rename": "Sitzung umbenennen",
  "command.session.rename.description": "Titel der aktuellen Sitzung ändern",
  ...
  "dialog.session.rename.title": "Sitzung umbenennen",
  "dialog.session.rename.name": "Sitzungsname",
  "dialog.session.rename.error.empty": "Geben Sie einen Sitzungsnamen ein.",
  "dialog.session.rename.failed.title": "Sitzung konnte nicht umbenannt werden",
  ...
  "sidebar.project.sessions.collapse": "Sitzungen einklappen",
  "sidebar.project.sessions.expand": "Sitzungen ausklappen",
  ...
  "settings.general.background.image.title": "Hintergrundbild",
  "settings.general.background.image.description":
    "Wählen Sie ein lokales Bild aus, das über dem App-Hintergrund angezeigt wird",
  "settings.general.background.choose": "Bild auswählen",
  "settings.general.background.choose.title": "Hintergrundbild auswählen",
  "settings.general.background.clear": "Leeren",
  "settings.general.background.enabled.title": "Hintergrundbild anzeigen",
  "settings.general.background.enabled.description": "Ausgewähltes Bild als dezenten App-Hintergrund anzeigen",
  "settings.general.background.fit.title": "Hintergrundlayout",
  "settings.general.background.fit.description": "Wählen Sie, wie das Hintergrundbild dargestellt wird",
  "settings.general.background.fit.cover": "Ausfüllen",
  "settings.general.background.fit.contain": "Einpassen",
  "settings.general.background.fit.repeat": "Wiederholen",
  "settings.general.background.opacity.title": "Hintergrunddeckkraft",
  "settings.general.background.blur.title": "Hintergrundunschärfe",
  ...
  "dialog.archivedSessions.menu": "Archivierte Sitzungen",
  "dialog.archivedSessions.title": "Archivierte Sitzungen",
  "dialog.archivedSessions.empty": "Keine archivierten Sitzungen",
  "dialog.archivedSessions.search.placeholder": "Archivierte Sitzungen durchsuchen",
  "dialog.archivedSessions.restore": "Wiederherstellen",
  "dialog.archivedSessions.delete": "Endgültig löschen",
  "dialog.archivedSessions.delete.confirm": 'Sitzung "{{name}}" endgültig löschen?',
  "dialog.archivedSessions.loadFailed.title": "Archivierte Sitzungen konnten nicht geladen werden",
  "dialog.archivedSessions.restoreFailed.title": "Sitzung konnte nicht wiederhergestellt werden",
  "settings.general.row.archivedSessions.title": "Archivierte Sitzungen",
  "settings.general.row.archivedSessions.description":
    "Archivierte Sitzungen ansehen und wiederherstellen oder endgültig löschen.",
  "settings.general.row.archivedSessions.action": "Verwalten",
