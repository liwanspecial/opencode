export const dict = {
  ...
  "command.session.rename": "Перейменувати сесію",
  "command.session.rename.description": "Змінити назву поточної сесії",
  ...
  "dialog.session.rename.title": "Перейменувати сесію",
  "dialog.session.rename.name": "Назва сесії",
  "dialog.session.rename.error.empty": "Введіть назву сесії.",
  "dialog.session.rename.failed.title": "Не вдалося перейменувати сесію",
  ...
  "settings.general.background.image.title": "Фонове зображення",
  "settings.general.background.image.description": "Виберіть локальне зображення для показу поверх фону застосунку",
  "settings.general.background.choose": "Вибрати зображення",
  "settings.general.background.choose.title": "Вибрати фонове зображення",
  "settings.general.background.clear": "Очистити",
  "settings.general.background.enabled.title": "Показувати фонове зображення",
  "settings.general.background.enabled.description": "Показувати вибране зображення як ненав'язливий фон застосунку",
  "settings.general.background.fit.title": "Макет фону",
  "settings.general.background.fit.description": "Виберіть, як відмальовується фонове зображення",
  "settings.general.background.fit.cover": "Заповнити",
  "settings.general.background.fit.contain": "Вмістити",
  "settings.general.background.fit.repeat": "Повторювати",
  "settings.general.background.opacity.title": "Непрозорість фону",
  "settings.general.background.blur.title": "Розмиття фону",
  ...
  "dialog.archivedSessions.menu": "Архівовані сесії",
  "dialog.archivedSessions.title": "Архівовані сесії",
  "dialog.archivedSessions.empty": "Архівованих сесій немає",
  "dialog.archivedSessions.search.placeholder": "Пошук архівованих сесій",
  "dialog.archivedSessions.restore": "Відновити",
  "dialog.archivedSessions.delete": "Видалити остаточно",
  "dialog.archivedSessions.delete.confirm": 'Остаточно видалити сесію "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Не вдалося завантажити архівовані сесії",
  "dialog.archivedSessions.restoreFailed.title": "Не вдалося відновити сесію",
  "settings.general.row.archivedSessions.title": "Архівовані сесії",
  "settings.general.row.archivedSessions.description":
    "Переглядайте архівовані сесії та відновлюйте або остаточно видаляйте їх.",
  "settings.general.row.archivedSessions.action": "Керувати",
