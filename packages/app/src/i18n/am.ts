export const dict = {
  ...
  "command.session.rename": "ክፍለ ጊዜን ዳግም ሰይም",
  "command.session.rename.description": "የአሁኑን ክፍለ ጊዜ ርዕስ ቀይር",
  ...
  "dialog.session.rename.title": "ክፍለ ጊዜን ዳግም ሰይም",
  "dialog.session.rename.name": "የክፍለ ጊዜ ስም",
  "dialog.session.rename.error.empty": "የክፍለ ጊዜ ስም ያስገቡ።",
  "dialog.session.rename.failed.title": "ክፍለ ጊዜን ዳግም መሰየም አልተሳካም",
  ...
  "sidebar.project.sessions.collapse": "ክፍለ ጊዜዎችን ሰብስብ",
  "sidebar.project.sessions.expand": "ክፍለ ጊዜዎችን ዘርጋ",
  ...
  "settings.general.background.image.title": "የጀርባ ምስል",
  "settings.general.background.image.description": "በመተግበሪያው ጀርባ ላይ ለማሳየት አካባቢያዊ ምስል ይምረጡ",
  "settings.general.background.choose": "ምስል ምረጥ",
  "settings.general.background.choose.title": "የጀርባ ምስል ምረጥ",
  "settings.general.background.clear": "አጽዳ",
  "settings.general.background.enabled.title": "የጀርባ ምስል አሳይ",
  "settings.general.background.enabled.description": "የተመረጠውን ምስል እንደ ስውር የመተግበሪያ ጀርባ አሳይ",
  "settings.general.background.fit.title": "የጀርባ አቀማመጥ",
  "settings.general.background.fit.description": "የጀርባ ምስሉ እንዴት እንደሚሳል ይምረጡ",
  "settings.general.background.fit.cover": "ሸፍን",
  "settings.general.background.fit.contain": "አካትት",
  "settings.general.background.fit.repeat": "ድገም",
  "settings.general.background.opacity.title": "የጀርባ ግልጽነት",
  "settings.general.background.blur.title": "የጀርባ ማደብዘዝ",
  ...
  "dialog.archivedSessions.menu": "በማህደር የተቀመጡ ክፍለ ጊዜዎች",
  "dialog.archivedSessions.title": "በማህደር የተቀመጡ ክፍለ ጊዜዎች",
  "dialog.archivedSessions.empty": "በማህደር የተቀመጡ ክፍለ ጊዜዎች የሉም",
  "dialog.archivedSessions.search.placeholder": "በማህደር የተቀመጡ ክፍለ ጊዜዎችን ፈልግ",
  "dialog.archivedSessions.restore": "ወደነበረበት መልስ",
  "dialog.archivedSessions.delete": "ለዘላቂነት ሰርዝ",
  "dialog.archivedSessions.delete.confirm": 'ክፍለ ጊዜ "{{name}}" ለዘላቂነት ይሰረዝ?',
  "dialog.archivedSessions.loadFailed.title": "በማህደር የተቀመጡ ክፍለ ጊዜዎችን መጫን አልተሳካም",
  "dialog.archivedSessions.restoreFailed.title": "ክፍለ ጊዜን ወደነበረበት መመለስ አልተሳካም",
  "settings.general.row.archivedSessions.title": "በማህደር የተቀመጡ ክፍለ ጊዜዎች",
  "settings.general.row.archivedSessions.description": "በማህደር የተቀመጡ ክፍለ ጊዜዎችን ይገምግሙ እና ወደነበሩበት ይመልሱ ወይም ለዘላቂነት ይሰርዙ።",
  "settings.general.row.archivedSessions.action": "አስተዳድር",
