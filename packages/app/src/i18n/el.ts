export const dict = {
  ...
  "command.session.rename": "Μετονομασία συνεδρίας",
  "command.session.rename.description": "Αλλαγή του τίτλου της τρέχουσας συνεδρίας",
  ...
  "dialog.session.rename.title": "Μετονομασία συνεδρίας",
  "dialog.session.rename.name": "Όνομα συνεδρίας",
  "dialog.session.rename.error.empty": "Εισαγάγετε όνομα συνεδρίας.",
  "dialog.session.rename.failed.title": "Αποτυχία μετονομασίας συνεδρίας",
  ...
  "sidebar.project.sessions.collapse": "Σύμπτυξη συνεδριών",
  "sidebar.project.sessions.expand": "Ανάπτυξη συνεδριών",
  ...
  "settings.general.background.image.title": "Εικόνα φόντου",
  "settings.general.background.image.description":
    "Επιλέξτε μια τοπική εικόνα για εμφάνιση πάνω από το φόντο της εφαρμογής",
  "settings.general.background.choose": "Επιλογή εικόνας",
  "settings.general.background.choose.title": "Επιλογή εικόνας φόντου",
  "settings.general.background.clear": "Διαγραφή",
  "settings.general.background.enabled.title": "Εμφάνιση εικόνας φόντου",
  "settings.general.background.enabled.description": "Εμφάνιση της επιλεγμένης εικόνας ως διακριτικού φόντου εφαρμογής",
  "settings.general.background.fit.title": "Διάταξη φόντου",
  "settings.general.background.fit.description": "Επιλέξτε πώς σχεδιάζεται η εικόνα φόντου",
  "settings.general.background.fit.cover": "Κάλυψη",
  "settings.general.background.fit.contain": "Προσαρμογή",
  "settings.general.background.fit.repeat": "Επανάληψη",
  "settings.general.background.opacity.title": "Αδιαφάνεια φόντου",
  "settings.general.background.blur.title": "Θόλωση φόντου",
  ...
  "dialog.archivedSessions.menu": "Αρχειοθετημένες συνεδρίες",
  "dialog.archivedSessions.title": "Αρχειοθετημένες συνεδρίες",
  "dialog.archivedSessions.empty": "Δεν υπάρχουν αρχειοθετημένες συνεδρίες",
  "dialog.archivedSessions.search.placeholder": "Αναζήτηση αρχειοθετημένων συνεδριών",
  "dialog.archivedSessions.restore": "Επαναφορά",
  "dialog.archivedSessions.delete": "Οριστική διαγραφή",
  "dialog.archivedSessions.delete.confirm": 'Οριστική διαγραφή συνεδρίας "{{name}}";',
  "dialog.archivedSessions.loadFailed.title": "Αποτυχία φόρτωσης αρχειοθετημένων συνεδριών",
  "dialog.archivedSessions.restoreFailed.title": "Αποτυχία επαναφοράς συνεδρίας",
  "settings.general.row.archivedSessions.title": "Αρχειοθετημένες συνεδρίες",
  "settings.general.row.archivedSessions.description":
    "Ελέγξτε τις αρχειοθετημένες συνεδρίες και επαναφέρετε ή διαγράψτε τις οριστικά.",
  "settings.general.row.archivedSessions.action": "Διαχείριση",
