export const dict = {
  ...
  "command.session.rename": "Sessiyanın adını dəyiş",
  "command.session.rename.description": "Cari sessiyanın başlığını dəyiş",
  ...
  "dialog.session.rename.title": "Sessiyanın adını dəyiş",
  "dialog.session.rename.name": "Sessiya adı",
  "dialog.session.rename.error.empty": "Sessiya adı daxil edin.",
  "dialog.session.rename.failed.title": "Sessiyanın adı dəyişdirilə bilmədi",
  ...
  "sidebar.project.sessions.collapse": "Sessiyaları yığ",
  "sidebar.project.sessions.expand": "Sessiyaları genişlət",
  ...
  "settings.general.background.image.title": "Fon şəkli",
  "settings.general.background.image.description": "Tətbiqin fonunda göstərmək üçün yerli şəkil seçin",
  "settings.general.background.choose": "Şəkil seç",
  "settings.general.background.choose.title": "Fon şəklini seç",
  "settings.general.background.clear": "Təmizlə",
  "settings.general.background.enabled.title": "Fon şəklini göstər",
  "settings.general.background.enabled.description": "Seçilmiş şəkli tətbiqin zərif fonu kimi göstər",
  "settings.general.background.fit.title": "Fon tərtibatı",
  "settings.general.background.fit.description": "Fon şəklinin necə göstəriləcəyini seçin",
  "settings.general.background.fit.cover": "Ört",
  "settings.general.background.fit.contain": "Sığdır",
  "settings.general.background.fit.repeat": "Təkrarla",
  "settings.general.background.opacity.title": "Fon qeyri-şəffaflığı",
  "settings.general.background.blur.title": "Fon bulanıqlığı",
  ...
  "dialog.archivedSessions.menu": "Arxivlənmiş sessiyalar",
  "dialog.archivedSessions.title": "Arxivlənmiş sessiyalar",
  "dialog.archivedSessions.empty": "Arxivlənmiş sessiya yoxdur",
  "dialog.archivedSessions.search.placeholder": "Arxivlənmiş sessiyaları axtar",
  "dialog.archivedSessions.restore": "Bərpa et",
  "dialog.archivedSessions.delete": "Həmişəlik sil",
  "dialog.archivedSessions.delete.confirm": '"{{name}}" sessiyasını həmişəlik silmək istəyirsiniz?',
  "dialog.archivedSessions.loadFailed.title": "Arxivlənmiş sessiyalar yüklənə bilmədi",
  "dialog.archivedSessions.restoreFailed.title": "Sessiya bərpa edilə bilmədi",
  "settings.general.row.archivedSessions.title": "Arxivlənmiş sessiyalar",
  "settings.general.row.archivedSessions.description":
    "Arxivlənmiş sessiyaları nəzərdən keçirin, onları bərpa edin və ya həmişəlik silin.",
  "settings.general.row.archivedSessions.action": "İdarə et",
