export const dict = {
  ...
  "command.session.rename": "セッション名を変更",
  "command.session.rename.description": "現在のセッションのタイトルを変更",
  ...
  "dialog.session.rename.title": "セッション名を変更",
  "dialog.session.rename.name": "セッション名",
  "dialog.session.rename.error.empty": "セッション名を入力してください。",
  "dialog.session.rename.failed.title": "セッション名の変更に失敗しました",
  ...
  "settings.general.background.image.title": "背景画像",
  "settings.general.background.image.description": "アプリの背景に表示するローカル画像を選択します",
  "settings.general.background.choose": "画像を選択",
  "settings.general.background.choose.title": "背景画像を選択",
  "settings.general.background.clear": "クリア",
  "settings.general.background.enabled.title": "背景画像を表示",
  "settings.general.background.enabled.description": "選択した画像を控えめなアプリ背景として表示します",
  "settings.general.background.fit.title": "背景レイアウト",
  "settings.general.background.fit.description": "背景画像の表示方法を選択します",
  "settings.general.background.fit.cover": "カバー",
  "settings.general.background.fit.contain": "収める",
  "settings.general.background.fit.repeat": "繰り返し",
  "settings.general.background.opacity.title": "背景の不透明度",
  "settings.general.background.blur.title": "背景のぼかし",
  ...
  "dialog.archivedSessions.menu": "アーカイブ済みセッション",
  "dialog.archivedSessions.title": "アーカイブ済みセッション",
  "dialog.archivedSessions.empty": "アーカイブ済みのセッションはありません",
  "dialog.archivedSessions.search.placeholder": "アーカイブ済みセッションを検索",
  "dialog.archivedSessions.restore": "復元",
  "dialog.archivedSessions.delete": "完全に削除",
  "dialog.archivedSessions.delete.confirm": 'セッション "{{name}}" を完全に削除しますか？',
  "dialog.archivedSessions.loadFailed.title": "アーカイブ済みセッションの読み込みに失敗しました",
  "dialog.archivedSessions.restoreFailed.title": "セッションの復元に失敗しました",
  "settings.general.row.archivedSessions.title": "アーカイブ済みセッション",
  "settings.general.row.archivedSessions.description": "アーカイブ済みセッションを確認し、復元または完全に削除します。",
