export const dict = {
  ...
  "command.session.rename": "Zmień nazwę sesji",
  "command.session.rename.description": "Zmień tytuł bieżącej sesji",
  ...
  "dialog.session.rename.title": "Zmień nazwę sesji",
  "dialog.session.rename.name": "Nazwa sesji",
  "dialog.session.rename.error.empty": "Wprowadź nazwę sesji.",
  "dialog.session.rename.failed.title": "Nie udało się zmienić nazwy sesji",
  ...
  "sidebar.project.sessions.collapse": "Zwiń sesje",
  "sidebar.project.sessions.expand": "Rozwiń sesje",
  ...
  "settings.general.background.image.title": "Obraz tła",
  "settings.general.background.image.description": "Wybierz lokalny obraz do wyświetlania jako tło aplikacji",
  "settings.general.background.choose": "Wybierz obraz",
  "settings.general.background.choose.title": "Wybierz obraz tła",
  "settings.general.background.clear": "Wyczyść",
  "settings.general.background.enabled.title": "Pokaż obraz tła",
  "settings.general.background.enabled.description": "Wyświetlaj wybrany obraz jako subtelne tło aplikacji",
  "settings.general.background.fit.title": "Układ tła",
  "settings.general.background.fit.description": "Wybierz sposób rysowania obrazu tła",
  "settings.general.background.fit.cover": "Wypełnij",
  "settings.general.background.fit.contain": "Dopasuj",
  "settings.general.background.fit.repeat": "Powtarzaj",
  "settings.general.background.opacity.title": "Krycie tła",
  "settings.general.background.blur.title": "Rozmycie tła",
  ...
  "dialog.archivedSessions.menu": "Zarchiwizowane sesje",
  "dialog.archivedSessions.title": "Zarchiwizowane sesje",
  "dialog.archivedSessions.empty": "Brak zarchiwizowanych sesji",
  "dialog.archivedSessions.search.placeholder": "Szukaj zarchiwizowanych sesji",
  "dialog.archivedSessions.restore": "Przywróć",
  "dialog.archivedSessions.delete": "Usuń trwale",
  "dialog.archivedSessions.delete.confirm": 'Trwale usunąć sesję "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Nie udało się załadować zarchiwizowanych sesji",
  "dialog.archivedSessions.restoreFailed.title": "Nie udało się przywrócić sesji",
  "settings.general.row.archivedSessions.title": "Zarchiwizowane sesje",
  "settings.general.row.archivedSessions.description": "Przejrzyj zarchiwizowane sesje i przywróć je lub trwale usuń.",
  "settings.general.row.archivedSessions.action": "Zarządzaj",
