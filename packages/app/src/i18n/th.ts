export const dict = {
  ...
  "command.session.rename": "เปลี่ยนชื่อเซสชัน",
  "command.session.rename.description": "เปลี่ยนชื่อเรื่องของเซสชันปัจจุบัน",
  ...
  "dialog.session.rename.title": "เปลี่ยนชื่อเซสชัน",
  "dialog.session.rename.name": "ชื่อเซสชัน",
  "dialog.session.rename.error.empty": "ป้อนชื่อเซสชัน.",
  "dialog.session.rename.failed.title": "ไม่สามารถเปลี่ยนชื่อเซสชัน",
  ...
  "sidebar.project.sessions.collapse": "ย่อเซสชัน",
  "sidebar.project.sessions.expand": "ขยายเซสชัน",
  ...
  "settings.general.background.image.title": "รูปภาพพื้นหลัง",
  "settings.general.background.image.description": "เลือกรูปภาพในเครื่องเพื่อแสดงบนพื้นหลังของแอป",
  "settings.general.background.choose": "เลือกรูปภาพ",
  "settings.general.background.choose.title": "เลือกรูปภาพพื้นหลัง",
  "settings.general.background.clear": "ล้าง",
  "settings.general.background.enabled.title": "แสดงรูปภาพพื้นหลัง",
  "settings.general.background.enabled.description": "แสดงรูปภาพที่เลือกเป็นพื้นหลังของแอปแบบจาง ๆ",
  "settings.general.background.fit.title": "เค้าโครงพื้นหลัง",
  "settings.general.background.fit.description": "เลือกวิธีแสดงรูปภาพพื้นหลัง",
  "settings.general.background.fit.cover": "ครอบคลุม",
  "settings.general.background.fit.contain": "แสดงเต็มภาพ",
  "settings.general.background.fit.repeat": "ทำซ้ำ",
  "settings.general.background.opacity.title": "ความทึบของพื้นหลัง",
  "settings.general.background.blur.title": "ความเบลอของพื้นหลัง",
  ...
  "dialog.archivedSessions.menu": "เซสชันที่จัดเก็บ",
  "dialog.archivedSessions.title": "เซสชันที่จัดเก็บ",
  "dialog.archivedSessions.empty": "ไม่มีเซสชันที่จัดเก็บ",
  "dialog.archivedSessions.search.placeholder": "ค้นหาเซสชันที่จัดเก็บ",
  "dialog.archivedSessions.restore": "กู้คืน",
  "dialog.archivedSessions.delete": "ลบถาวร",
  "dialog.archivedSessions.delete.confirm": 'ลบเซสชัน "{{name}}" ถาวรหรือไม่?',
  "dialog.archivedSessions.loadFailed.title": "ไม่สามารถโหลดเซสชันที่จัดเก็บ",
  "dialog.archivedSessions.restoreFailed.title": "ไม่สามารถกู้คืนเซสชัน",
  "settings.general.row.archivedSessions.title": "เซสชันที่จัดเก็บ",
  "settings.general.row.archivedSessions.description": "ตรวจสอบเซสชันที่จัดเก็บ แล้วกู้คืนหรือลบถาวร.",
  "settings.general.row.archivedSessions.action": "จัดการ",
