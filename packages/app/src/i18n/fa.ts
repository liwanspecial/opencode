export const dict = {
  ...
  "command.session.rename": "تغییر نام جلسه",
  "command.session.rename.description": "عنوان جلسه فعلی را تغییر دهید",
  ...
  "dialog.session.rename.title": "تغییر نام جلسه",
  "dialog.session.rename.name": "نام جلسه",
  "dialog.session.rename.error.empty": "نام جلسه را وارد کنید.",
  "dialog.session.rename.failed.title": "تغییر نام جلسه انجام نشد",
  ...
  "sidebar.project.sessions.collapse": "جمع کردن جلسات",
  "sidebar.project.sessions.expand": "گسترش جلسات",
  ...
  "settings.general.background.image.title": "تصویر پس‌زمینه",
  "settings.general.background.image.description": "یک تصویر محلی برای نمایش روی پس‌زمینه برنامه انتخاب کنید",
  "settings.general.background.choose": "انتخاب تصویر",
  "settings.general.background.choose.title": "انتخاب تصویر پس‌زمینه",
  "settings.general.background.clear": "پاک کردن",
  "settings.general.background.enabled.title": "نمایش تصویر پس‌زمینه",
  "settings.general.background.enabled.description":
    "تصویر انتخاب‌شده را به‌عنوان پس‌زمینه‌ای ملایم برای برنامه نمایش دهید",
  "settings.general.background.fit.title": "چیدمان پس‌زمینه",
  "settings.general.background.fit.description": "نحوه ترسیم تصویر پس‌زمینه را انتخاب کنید",
  "settings.general.background.fit.cover": "پوشاندن",
  "settings.general.background.fit.contain": "جا دادن",
  "settings.general.background.fit.repeat": "تکرار",
  "settings.general.background.opacity.title": "شفافیت پس‌زمینه",
  "settings.general.background.blur.title": "تاری پس‌زمینه",
  ...
  "dialog.archivedSessions.menu": "جلسات بایگانی‌شده",
  "dialog.archivedSessions.title": "جلسات بایگانی‌شده",
  "dialog.archivedSessions.empty": "هیچ جلسه بایگانی‌شده‌ای وجود ندارد",
  "dialog.archivedSessions.search.placeholder": "جستجوی جلسات بایگانی‌شده",
  "dialog.archivedSessions.restore": "بازیابی",
  "dialog.archivedSessions.delete": "حذف دائمی",
  "dialog.archivedSessions.delete.confirm": "جلسه «{{name}}» برای همیشه حذف شود؟",
  "dialog.archivedSessions.loadFailed.title": "جلسات بایگانی‌شده بارگیری نشدند",
  "dialog.archivedSessions.restoreFailed.title": "جلسه بازیابی نشد",
  "settings.general.row.archivedSessions.title": "جلسات بایگانی‌شده",
  "settings.general.row.archivedSessions.description":
    "جلسات بایگانی‌شده را بررسی کنید و آن‌ها را بازیابی یا برای همیشه حذف کنید.",
  "settings.general.row.archivedSessions.action": "مدیریت",
