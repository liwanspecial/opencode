...
export const dict = {
  ...
  "command.session.rename": "Preimenuj sesiju",
  "command.session.rename.description": "Promijeni naslov trenutne sesije",
  ...
  "dialog.session.rename.title": "Preimenuj sesiju",
  "dialog.session.rename.name": "Naziv sesije",
  "dialog.session.rename.error.empty": "Unesite naziv sesije.",
  "dialog.session.rename.failed.title": "Preimenovanje sesije nije uspjelo",
  ...
  "sidebar.project.sessions.collapse": "Sažmi sesije",
  "sidebar.project.sessions.expand": "Proširi sesije",
  ...
  "settings.general.background.image.title": "Pozadinska slika",
  "settings.general.background.image.description": "Odaberite lokalnu sliku za prikaz preko pozadine aplikacije",
  "settings.general.background.choose": "Odaberi sliku",
  "settings.general.background.choose.title": "Odaberi pozadinsku sliku",
  "settings.general.background.clear": "Očisti",
  "settings.general.background.enabled.title": "Prikaži pozadinsku sliku",
  "settings.general.background.enabled.description": "Prikaži odabranu sliku kao suptilnu pozadinu aplikacije",
  "settings.general.background.fit.title": "Raspored pozadine",
  "settings.general.background.fit.description": "Odaberite kako se iscrtava pozadinska slika",
  "settings.general.background.fit.cover": "Ispuni",
  "settings.general.background.fit.contain": "Uklopi",
  "settings.general.background.fit.repeat": "Ponavljaj",
  "settings.general.background.opacity.title": "Neprozirnost pozadine",
  "settings.general.background.blur.title": "Zamućenje pozadine",
  ...
  "dialog.archivedSessions.menu": "Arhivirane sesije",
  ...
  "dialog.archivedSessions.delete.confirm": 'Trajno izbrisati sesiju "{{name}}"?',
  "dialog.archivedSessions.loadFailed.title": "Učitavanje arhiviranih sesija nije uspjelo",
  "dialog.archivedSessions.restoreFailed.title": "Vraćanje sesije nije uspjelo",
  "settings.general.row.archivedSessions.title": "Arhivirane sesije",
  "settings.general.row.archivedSessions.description":
    "Pregledajte arhivirane sesije te ih vratite ili trajno izbrišite.",
