export const dict = {
  ...
  "command.session.rename": "စက်ရှင်အမည်ပြောင်းပါ။",
  "command.session.rename.description": "လက်ရှိစက်ရှင်ခေါင်းစဉ်ကို ပြောင်းပါ။",
  ...
  "dialog.session.rename.title": "စက်ရှင်အမည်ပြောင်းပါ။",
  "dialog.session.rename.name": "စက်ရှင်အမည်",
  "dialog.session.rename.error.empty": "စက်ရှင်အမည် ထည့်ပါ။",
  "dialog.session.rename.failed.title": "စက်ရှင်အမည် ပြောင်း၍မရပါ။",
  ...
  "common.refresh": "ပြန်လည်ဆန်းသစ်ပါ။",
  ...
  "sidebar.project.sessions.collapse": "ဆက်ရှင်များကို ခေါက်သိမ်းပါ။",
  "sidebar.project.sessions.expand": "ဆက်ရှင်များကို ချဲ့ပါ။",
  ...
  "settings.general.background.image.title": "နောက်ခံပုံ",
  "settings.general.background.image.description": "အက်ပ်နောက်ခံပေါ်တွင် ပြရန် စက်တွင်းပုံတစ်ခုကို ရွေးပါ။",
  "settings.general.background.choose": "ပုံရွေးပါ။",
  "settings.general.background.choose.title": "နောက်ခံပုံကို ရွေးပါ။",
  "settings.general.background.clear": "ရှင်းလင်းပါ။",
  "settings.general.background.enabled.title": "နောက်ခံပုံကို ပြပါ။",
  "settings.general.background.enabled.description": "ရွေးထားသောပုံကို အက်ပ်နောက်ခံတွင် သိမ်မွေ့စွာ ပြပါ။",
  "settings.general.background.fit.title": "နောက်ခံပုံ အပြင်အဆင်",
  "settings.general.background.fit.description": "နောက်ခံပုံကို မည်သို့ပြမည်ကို ရွေးပါ။",
  "settings.general.background.fit.cover": "ဖုံးလွှမ်း",
  "settings.general.background.fit.contain": "အပြည့်ပါဝင်",
  "settings.general.background.fit.repeat": "ထပ်ခါပြ",
  "settings.general.background.opacity.title": "နောက်ခံ opacity",
  "settings.general.background.blur.title": "နောက်ခံဝါးမှု",
  ...
  "dialog.archivedSessions.menu": "သိမ်းဆည်းထားသော ဆက်ရှင်များ",
  "dialog.archivedSessions.title": "သိမ်းဆည်းထားသော ဆက်ရှင်များ",
  "dialog.archivedSessions.empty": "သိမ်းဆည်းထားသော ဆက်ရှင်များ မရှိပါ။",
  "dialog.archivedSessions.search.placeholder": "သိမ်းဆည်းထားသော ဆက်ရှင်များကို ရှာဖွေပါ။",
  "dialog.archivedSessions.restore": "ပြန်ယူပါ။",
  "dialog.archivedSessions.delete": "အပြီးတိုင် ဖျက်ပါ။",
  "dialog.archivedSessions.delete.confirm": 'စက်ရှင် "{{name}}" ကို အပြီးတိုင် ဖျက်မလား။',
  "dialog.archivedSessions.loadFailed.title": "သိမ်းဆည်းထားသော ဆက်ရှင်များကို တင်၍မရပါ။",
  "dialog.archivedSessions.restoreFailed.title": "စက်ရှင်ကို ပြန်ယူ၍မရပါ။",
  "settings.general.row.archivedSessions.title": "သိမ်းဆည်းထားသော ဆက်ရှင်များ",
  "settings.general.row.archivedSessions.description":
    "သိမ်းဆည်းထားသော ဆက်ရှင်များကို ပြန်လည်သုံးသပ်ပြီး ပြန်ယူပါ သို့မဟုတ် အပြီးတိုင် ဖျက်ပါ။",
  "settings.general.row.archivedSessions.action": "စီမံပါ။",
